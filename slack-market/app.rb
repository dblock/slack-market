  ...
  class App < SlackRubyBotServer::App
    ...
    def deactivate_asleep_teams!
      Team.active.each do |team|
        ...
        begin
          team.deactivate!
          team.inform! "This integration hasn't been used for 2 weeks, deactivating. Reactivate at https://market.playplay.io. Your data will be purged in another 2 weeks.", 'asleep'
